package org.example.adminservice.config.kafka;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, AdminRequest> consumerFactory() {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, AdminRequest> kafkaListenerContainerFactory(
            ConsumerFactory<String, AdminRequest> consumerFactory, CommonErrorHandler commonErrorHandler) {
